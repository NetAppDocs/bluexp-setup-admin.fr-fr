...
summary: 'Créez le connecteur directement à partir de la console web BlueXP, à l"aide de gcloud ou en installant le logiciel sur votre propre hôte Linux.' 
---
= Créez le connecteur dans Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Créez le connecteur directement à partir de la console web BlueXP, à l'aide de gcloud ou en installant le logiciel sur votre propre hôte Linux.
