...
---
= Abonnement aux services de données BlueXP  (mode standard)
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Un abonnement Marketplace permet de facturer les services de données BlueXP  suivants :
