...
.Étapes
. Créez un compte sur le site de support NetApp en complétant le https://["Formulaire d'inscription de l'utilisateur du site de support NetApp"^]
+
...
. Accédez à https://["Site d'inscription au support NetApp"^] Et sélectionnez *je ne suis pas un client NetApp enregistré*.
