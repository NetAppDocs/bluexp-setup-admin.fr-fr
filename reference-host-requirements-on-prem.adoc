...
summary: 'Le logiciel du connecteur doit être exécuté sur un hôte qui répond à des exigences spécifiques du système d"exploitation, de la RAM, des ports, etc. Assurez-vous que votre hôte répond à ces exigences avant d"installer le connecteur.' 
---
