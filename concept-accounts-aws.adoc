...
summary: 'Découvrez comment BlueXP utilise les identifiants et les autorisations AWS pour gérer les identifiants d"un ou plusieurs comptes AWS. Par exemple, vous pourriez vouloir en savoir plus sur l"ajout d"identifiants AWS supplémentaires à BlueXP.' 
---
...
[role="lead"]
Découvrez comment BlueXP utilise les identifiants et les autorisations AWS pour gérer les identifiants d'un ou plusieurs comptes AWS. Par exemple, vous pourriez vouloir en savoir plus sur l'ajout d'identifiants AWS supplémentaires à BlueXP.
