...
.Étapes
. Accédez au https://["Page NetApp BlueXP sur Google Cloud Marketplace"^] pour vérifier l'état de la commande. Si la page indique *gérer sur le fournisseur*, faites défiler la page vers le bas et sélectionnez *gérer les commandes*.
+
