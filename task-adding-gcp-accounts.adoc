...
summary: 'Vous pouvez gérer les identifiants Google Cloud associés à l"instance de machine virtuelle Connector.' 
---
...
[role="lead"]
Vous pouvez gérer les identifiants Google Cloud associés à l'instance de machine virtuelle Connector.
