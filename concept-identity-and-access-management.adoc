...
Les dossiers peuvent contenir des projets, d’autres dossiers ou les deux.
...
Lorsqu'une ressource est associée à un dossier, elle n'est pas automatiquement accessible à tous les projets ; seul l'administrateur du dossier ou du projet peut la voir. L'administrateur du dossier ou du projet décide quels projets peuvent y accéder et associe la ressource aux projets concernés.
