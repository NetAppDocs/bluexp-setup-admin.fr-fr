...
Pour gérer les dossiers, les utilisateurs doivent disposer du rôle d'administrateur Organisation ou dossier ou projet. Les utilisateurs avec le rôle d'administrateur d'entreprise peuvent créer et gérer des ressources partout dans votre organisation BlueXP . Les utilisateurs ayant un rôle d'administrateur de dossier et de projet ne peuvent le faire que pour les dossiers ou projets auxquels ils ont été affectés.

Lien ::Reference-iam-predefined-roles.html[en savoir plus sur les rôles BlueXP .]

Lors de l'utilisation de BlueXP  IAM, les utilisateurs ayant ces rôles géreront les composants suivants :
...
Une _organisation_ est le premier niveau du système IAM de BlueXP  et représente généralement votre entreprise. Votre organisation est constituée de ressources telles que les connecteurs, le stockage et les abonnements que vous pouvez organiser en dossiers et projets. Vous pouvez ensuite attribuer aux membres de l'organisation (utilisateurs) un accès aux dossiers ou aux projets en fonction de leurs responsabilités dans la gestion de vos environnements de stockage.
...
Selon la taille de votre organisation et le nombre de ressources de stockage dont vous disposez, les dossiers sont un outil utile pour maintenir l'organisation de vos ressources NetApp. Ils vous permettent également de mieux gérer l'accès si vous souhaitez partager l'administration de différents dossiers avec différents utilisateurs. Vous pouvez attribuer à un utilisateur le rôle d'administrateur de dossier ou de projet pour un dossier particulier et ils peuvent ensuite gérer l'accès au dossier et à ses projets, ainsi que créer de nouveaux projets dans le dossier.

Lorsque vous créez un dossier, vous pouvez lui attribuer l'accès des utilisateurs. Lorsque vous attribuez un rôle d'accès à un dossier à un utilisateur, celui-ci peut effectuer les tâches associées à ce rôle pour tous les projets du dossier correspondant. Inversement, vous pouvez choisir d'accorder à l'utilisateur l'accès à un projet par projet.
...
Vous créez plusieurs projets pour fournir un accès plus granulaire à vos ressources NetApp. Par exemple, les petites organisations peuvent avoir un projet pour chaque unité commerciale ou emplacement géographique. Les grandes entreprises peuvent souhaiter organiser leurs ressources de stockage en plusieurs projets par unité commerciale afin de mieux contrôler l'accès. Vous pouvez attribuer aux utilisateurs l'accès aux ressources par projet ou dossier.
...
Lorsque vos projets résident dans un dossier, vous pouvez le faire
