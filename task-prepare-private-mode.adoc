...
Terminaux des opérations quotidiennes:: Le connecteur contacte les terminaux suivants pour gérer les ressources et les processus au sein de votre environnement de cloud public.
+
--
[cols="2a,1a"]
|===
