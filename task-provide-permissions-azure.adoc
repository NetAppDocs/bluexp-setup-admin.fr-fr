...
summary: 'Si vous avez créé le connecteur à partir d"Azure Marketplace ou installé manuellement le logiciel, vous devez fournir à BlueXP les autorisations que vous avez précédemment configurées.' 
---
