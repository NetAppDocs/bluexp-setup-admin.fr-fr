...
Sauvegarde et restauration BlueXP:: Sauvegardez et restaurez des données dans le cloud et sur site.
...
Copie et synchronisation BlueXP:: Synchronisez les données entre des datastores sur site et dans le cloud.
