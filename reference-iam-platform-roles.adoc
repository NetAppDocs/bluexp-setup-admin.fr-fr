...
summary: 'Attribuez des rôles de plateforme aux utilisateurs pour accorder des autorisations pour effectuer des tâches d"administration dans BlueXP, attribuez des rôles, ajoutez des utilisateurs, créez des connecteurs et gérez les fédérations.' 
---
...
[role="lead"]
Attribuez des rôles de plateforme aux utilisateurs pour accorder des autorisations pour effectuer des tâches d'administration dans BlueXP, attribuez des rôles, ajoutez des utilisateurs, créez des connecteurs et gérez les fédérations.
