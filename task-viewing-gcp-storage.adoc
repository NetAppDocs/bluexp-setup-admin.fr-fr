...
+
Pour plus de détails, voir https://docs.netapp.com/us-en/bluexp-copy-sync/concept-cloud-sync.html["Présentation de la copie et de la synchronisation BlueXP"^]
