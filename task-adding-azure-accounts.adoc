...
.. Cliquez sur *Notifications* et cliquez sur le lien de la notification pour configurer votre compte.
...
+
image:screenshot-azure-subscription.png["Capture d'écran de la page attribution d'abonnement qui vous permet d'associer cet abonnement à un ou plusieurs comptes et de choisir de remplacer l'abonnement existant pour l'un de ces comptes."]
