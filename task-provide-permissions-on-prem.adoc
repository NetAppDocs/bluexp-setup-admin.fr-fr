...
.Résultat
BlueXP dispose désormais des autorisations dont il a besoin pour effectuer des actions dans AWS en votre nom. Vous pouvez maintenant accéder au https://["Console BlueXP"^] Pour commencer à utiliser le connecteur avec BlueXP.
...
.Résultat
BlueXP dispose désormais des autorisations dont il a besoin pour effectuer des actions dans Azure en votre nom. Vous pouvez maintenant accéder au https://["Console BlueXP"^] Pour commencer à utiliser le connecteur avec BlueXP.
