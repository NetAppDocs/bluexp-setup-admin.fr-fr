...
Si vous utilisez le mode standard, vous pouvez commencer à utiliser BlueXP  pour gérer de manière centralisée vos ressources de stockage sans installer de connecteur.
