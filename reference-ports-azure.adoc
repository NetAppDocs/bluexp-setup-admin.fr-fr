...
| Appels API et AutoSupport | HTTPS | 443 | LIF de gestion de cluster ONTAP et Internet sortant | Appels d'API vers Azure, vers ONTAP, vers la classification BlueXP, vers la protection BlueXP contre les ransomware et envoi de messages AutoSupport à NetApp 
