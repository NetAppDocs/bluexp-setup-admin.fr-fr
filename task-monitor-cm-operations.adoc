...
[NOTE]
====
* Les notifications sont envoyées par e-mail pour les fonctionnalités et services BlueXP  suivants : le connecteur, le portefeuille digital BlueXP , la copie et la synchronisation BlueXP , ainsi que la sauvegarde et la restauration BlueXP .
