...
summary: 'Vous devez comprendre comment BlueXP utilise les identifiants et les autorisations Google Cloud pour pouvoir gérer les identifiants d"un ou plusieurs projets Google Cloud.' 
---
...
[role="lead"]
Vous devez comprendre comment BlueXP utilise les identifiants et les autorisations Google Cloud pour pouvoir gérer les identifiants d'un ou plusieurs projets Google Cloud.
