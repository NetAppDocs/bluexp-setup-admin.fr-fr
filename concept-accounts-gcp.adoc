...
summary: 'Découvrez comment BlueXP utilise les identifiants et les autorisations Google Cloud pour vous permettre de gérer les identifiants d"un ou plusieurs projets Google Cloud. Par exemple, vous pourriez vouloir en savoir plus sur le compte de service associé à la VM Connector.' 
---
...
[role="lead"]
Découvrez comment BlueXP utilise les identifiants et les autorisations Google Cloud pour vous permettre de gérer les identifiants d'un ou plusieurs projets Google Cloud. Par exemple, vous pourriez vouloir en savoir plus sur le compte de service associé à la VM Connector.
