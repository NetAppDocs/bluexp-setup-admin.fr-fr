...
summary: 'Découvrez comment BlueXP utilise les identifiants et les autorisations Azure pour gérer les identifiants d"un ou plusieurs abonnements Azure. Par exemple, découvrez comment ajouter des informations d"identification Azure à BlueXP.' 
---
...
[role="lead"]
Découvrez comment BlueXP utilise les identifiants et les autorisations Azure pour gérer les identifiants d'un ou plusieurs abonnements Azure. Par exemple, découvrez comment ajouter des informations d'identification Azure à BlueXP.
