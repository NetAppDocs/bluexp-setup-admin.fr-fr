...
image:screenshot_accounts_switch_azure.gif["Capture d'écran permettant de sélectionner un compte de fournisseur cloud après avoir cliqué sur changer de compte dans la page Détails  Credentials."]
