...
Pour plus de détails, reportez-vous à la https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["Documentation BlueXP pour Amazon FSX pour ONTAP"^]
