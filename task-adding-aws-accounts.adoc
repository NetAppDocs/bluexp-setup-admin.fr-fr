...
Après avoir ajouté vos identifiants AWS à BlueXP , vous pouvez configurer un abonnement AWS Marketplace avec ces identifiants. L'abonnement vous permet de payer Cloud Volumes ONTAP à un taux horaire (PAYGO) ou à l'aide d'un contrat annuel, et d'utiliser d'autres services BlueXP.

Dans deux cas, vous pouvez configurer un abonnement AWS Marketplace après avoir déjà ajouté les informations d'identification à BlueXP  :

* Vous n'avez pas configuré d'abonnement lorsque vous avez ajouté les informations d'identification à BlueXP .
