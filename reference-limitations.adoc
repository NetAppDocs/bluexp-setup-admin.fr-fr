...
Si votre réseau dispose d'un sous-réseau configuré avec l'une de ces plages, vous risquez de rencontrer des échecs de connectivité de BlueXP.  Par exemple, la découverte de clusters ONTAP sur site dans BlueXP peut échouer.
