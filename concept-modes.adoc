...
| Sauvegarde et restauration | Seules les opérations de sauvegarde et de restauration de volumes ONTAP sur site sur des systèmes StorageGRID sont prises en charge.
...
| Tiering | Non | Non | Mise en cache du volume 


| Non | Non .4+| *Caractéristiques* | Informations d'identification 
