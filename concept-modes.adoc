...
+
--
Une région sécurisée inclut https://["AWS C2S ET SC2S"^] et https://["Azure IL6"^]
...
Comment démarrer avec le mode standard:: Accédez au https://["Console web BlueXP"^] et s'inscrire.
+
--
...
| Sauvegarde et restauration | Pris en charge dans les régions commerciales AWS et Azure. Non pris en charge dans Google Cloud ou dans https://["AWS C2S/SC2S"^] ou https://["Azure IL6"^] 
...
| Sauvegarde et restauration | Seules les opérations de sauvegarde et de restauration de volumes ONTAP sur site sur des systèmes StorageGRID sont prises en charge.https://["Découvrez comment sauvegarder vos données ONTAP sur site dans StorageGRID"^] 


| Classement  a| 
* Les seules sources de données prises en charge sont celles que vous pouvez découvrir localement.
+
https://["Affichez les sources que vous pouvez découvrir localement"^]

* Les fonctionnalités nécessitant un accès Internet sortant ne sont pas prises en charge.
+
https://["Afficher les limites de la fonction"^]
...
https://["Découvrez comment ajouter des licences au portefeuille digital BlueXP"^]
