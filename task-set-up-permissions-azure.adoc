...
[role="lead"]
Configurez les autorisations Azure pour que vous puissiez utiliser BlueXP pour gérer vos données et votre infrastructure de stockage dans Azure. La manière dont vous configurez les autorisations dépend de l'option d'installation que vous prévoyez d'utiliser.
