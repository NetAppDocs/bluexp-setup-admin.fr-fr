...
+
.. Sélectionnez le rôle *Azure SetupAsService* et sélectionnez *Next*.
+
...
.. Sélectionnez *Sélectionner des membres*, choisissez votre compte d'utilisateur et sélectionnez *Sélectionner*.
