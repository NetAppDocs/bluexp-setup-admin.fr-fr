...
==== Prise en charge de Docker Engine 26

Docker Engine est l'outil d'orchestration de conteneurs requis lors de l'installation du connecteur sur Ubuntu 22.04 LTS.

À partir de la version 3.9.44 du connecteur, Docker Engine 26 est désormais pris en charge avec les installations _New_ Connector.

La liste mise à jour des versions de Docker Engine prises en charge est la suivante :
