...
summary: 'Découvrez les nouveautés des fonctionnalités d"administration BlueXP : comptes NetApp, connecteurs, identifiants de fournisseur cloud et bien plus encore.' 
---
= Quoi de neuf
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Découvrez les nouveautés des fonctionnalités d'administration BlueXP : comptes NetApp, connecteurs, identifiants de fournisseur cloud et bien plus encore.
