...
image:screenshot-edit-name.png["Capture d'écran qui montre la possibilité de modifier votre nom sous Paramètres utilisateur."]
...
=== Exigences du service de métadonnées de l'instance Amazon EC2

Vous devez savoir qu'IMDSv1 est requis sur les instances EC2 avant d'installer manuellement le logiciel Connector dans AWS.

link:reference-limitations.html["En savoir plus sur l'exigence d'IMDSv1 dans AWS"].
