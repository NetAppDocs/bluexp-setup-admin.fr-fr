...
==== le mode restreint utilise maintenant BlueXP  IAM
...
=== gestion des accès et des identités BlueXP 
...
=== Créer un dossier de demande de support pour des services BlueXP  supplémentaires
...
=== libération du mode privé (3.9.46)
...
=== prise en charge de SELinux avec hôtes RHEL
...
=== libération du mode privé (3.9.44)
...
=== Configuration CPU et RAM mise à jour
...
=== libération du mode privé (3.9.42)
...
=== Configuration requise du moteur Docker mise à jour
...
=== la vérification de l'adresse e-mail est maintenant requise
...
=== libération du mode privé (3.9.40)
...
=== libération du mode privé (3.9.38)
...
=== Paramètres proxy et paramètres Cloud Volumes ONTAP
...
=== libération du mode privé (3.9.35)
...
=== connexion avec les informations d'identification NetApp
...
=== extrémités réduites pour le connecteur
...
==== cryptage de disque EBS pour le connecteur
...
=== adresse e-mail pour les comptes NSS
...
=== mise à jour requise pour les comptes du site de support NetApp
...
=== Modifier les comptes NSS pour Cloud Volumes ONTAP
...
=== authentification avec l'entité de service
...
=== améliorations apportées à l'assistant Ajouter un connecteur
...
=== gestion de compte NSS à partir du tableau de bord de support
...
=== améliorations Cloud Volumes ONTAP
...
=== améliorations Azure NetApp Files
...
=== améliorations du tableau de bord de support
