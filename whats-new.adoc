...
+
https://["Afficher la liste complète des régions prises en charge"^]

* Cette version du connecteur inclut des améliorations Cloud Volumes ONTAP.
+
https://["Découvrez les améliorations apportées à Cloud Volumes ONTAP"^]
...
https://["En savoir plus sur ces modes de déploiement"].
...
+
https://["Découvrez comment configurer les notifications par e-mail"].
...
+
https://["Découvrez comment gérer les informations d'identification des utilisateurs"].
...
+
https://["Découvrez comment créer et gérer des dossiers de demande de support"].
...
+
** https://["Découvrez les améliorations apportées à Cloud Volumes ONTAP"^]
** https://["Découvrez les améliorations apportées aux clusters sur site de ONTAP"^]
...
+
https://["Découvrez comment gérer vos dossiers de demande de support"].
...
+
** https://["Installez le connecteur dans un emplacement sans accès à Internet"^]
** https://["Accéder à la console BlueXP sur le connecteur"^]
** https://["Ajouter une licence non attribuée"^]
** https://["Lancez-vous avec Cloud Volumes ONTAP"^]


* Connector vous permet désormais d'ajouter et de gérer des compartiments Amazon S3 à partir de BlueXP.
+
https://["Découvrez comment ajouter de nouveaux compartiments Amazon S3 dans votre compte AWS à partir de BlueXP"^].
...
+
** https://["Découvrez comment associer un abonnement AWS"]
** https://["Découvrez comment associer un abonnement Azure"]
** https://["Découvrez comment associer un abonnement Google Cloud"]


* BlueXP vous avertira désormais si votre connecteur a été mis hors tension pendant 14 jours ou plus.
+
** https://["En savoir plus sur les notifications BlueXP"]
** https://["Découvrez pourquoi les connecteurs doivent rester en fonctionnement"]
...
+
https://["Afficher les autorisations Google Cloud pour le connecteur"].
...
* Nous avons mis à jour l'URL de la console BlueXP vers https://[]
...
+
https://["Découvrez comment gérer vos abonnements"^]
...
Cloud Manager vous invite à mettre à jour les identifiants associés à vos comptes sur le site de support NetApp lorsque le jeton de mise à jour associé à votre compte expire au bout de 3 mois. https://["Découvrez comment gérer des comptes NSS"^]
...
+
https://["Découvrez comment créer un dossier"].
...
+
https://["Découvrez comment découvrir FSX pour ONTAP à l'aide de Mes opportunités"^]
...
https://["Voici un exemple illustrant les autorisations de rôle IAM AWS utilisées pour créer un connecteur"].

Nous avons également créé une page qui contient des liens vers chacune des politiques. https://["Consultez le récapitulatif des autorisations pour Cloud Manager"].
...
+
https://["Pour en savoir plus sur la surveillance des opérations, consultez votre compte"].
...
* Nous avons certifié le connecteur dans Google Cloud sur une instance de machine virtuelle avec un système d'exploitation pris en charge https://["Fonctionnalités MV blindées"^]
* Cette version du connecteur inclut également des améliorations Cloud Volumes ONTAP. https://["Découvrez ces améliorations"^]
...
+
https://["Apprendre à créer un connecteur à l'aide d'un rôle IAM"].
...
Cette version du connecteur inclut des améliorations Cloud Volumes ONTAP. https://["Découvrez ces améliorations"^]
...
https://["Afficher la liste des terminaux requis"]
...
* https://["En savoir plus sur l'utilisation par NetApp de Microsoft Azure AD pour la gestion des identités"^]
...
https://["En savoir plus sur la vérification de AutoSupport avec Cloud Volumes ONTAP"^]
