...
.Étapes
. Si vous créez votre premier environnement de travail, sélectionnez *Ajouter un environnement de travail* et suivez les invites. Sinon, sélectionnez la liste déroulante *Connector* et sélectionnez *Add Connector*.
+
