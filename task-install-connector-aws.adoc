...
summary: 'Installez le connecteur dans AWS directement à partir de la console web BlueXP, d"AWS Marketplace ou en installant le logiciel sur votre propre hôte Linux.' 
---
= Créez le connecteur dans AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Créez le connecteur directement à partir de la console web BlueXP, d'AWS Marketplace ou en installant le logiciel sur votre propre hôte Linux.
